            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{ url('/updaterujukan', array($users->id))}}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group{{ $errors->has('namarujukan') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="namarujukan" type="text" class="form-control" name="namarujukan" value="<?php echo $users->namarujukan; ?>" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('notelrujukan') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="notelrujukan" type="notelrujukan" class="form-control" name="notelrujukan" value="<?php echo $users->notelrujukan; ?>" required>
                                    ...
                                    <div class="form-group{{ $errors->has('jawatan') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="jawatan" type="jawatan" class="form-control" name="jawatan" value="<?php echo $users->jawatanrujukan; ?>" required>
                                    ...
                                    <div class="panel-heading">Rujukan 2</div>
                                     <div class="form-group{{ $errors->has('namarujukan2') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="namarujukan2" type="text" class="form-control" name="namarujukan2" value="<?php echo $users->namarujukan2; ?>" >
                                    ...
                                    <div class="form-group{{ $errors->has('notelrujukan2') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="notelrujukan2" type="notelrujukan2" class="form-control" name="notelrujukan2" value="<?php echo $users->notelrujukan2; ?>" >
                                    ...
                                    <div class="form-group{{ $errors->has('jawatan2') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="jawatan2" type="jawatan2" class="form-control" name="jawatan2" value="<?php echo $users->jawatanrujukan2; ?>">
