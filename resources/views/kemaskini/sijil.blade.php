            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{ url('/updatesijil', array($users->id))}}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group{{ $errors->has('tahunsijil') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-12">
                                        <input id="tahunsijil" type="tahunsijil" class="form-control mydatepicker" name="tahunsijil" value="<?php echo $users->tahungrad; ?>" required>
