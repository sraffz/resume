            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{ url('/updatepengalaman', array($users->id))}}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group{{ $errors->has('namasyarikat') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input  onkeyup="this.value = this.value.toUpperCase();" id="namasyarikat" type="text" class="form-control" name="namasyarikat" value="<?php echo $users->namasyr; ?>" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('alamatsyarikat') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="alamatsyarikat" type="alamatsyarikat" class="form-control" name="alamatsyarikat" value="<?php echo $users->alamatsyr; ?>" required>
                                    ...
                                    <div class="form-group{{ $errors->has('notelsyarikat') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="notelsyarikat" type="notelsyarikat" class="form-control" name="notelsyarikat" value="<?php echo $users->notelsyr; ?>" required>
                                    ...
                                    <div class="form-group{{ $errors->has('jawatan') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="jawatan" type="jawatan" class="form-control" name="jawatan" value="<?php echo $users->jwtnsyr; ?>" required>
                                    ...
                                    <div class="form-group{{ $errors->has('tempohkhidmat') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="tempohkhidmat" type="tempohkhidmat" class="form-control" name="tempohkhidmat" value="<?php echo $users->tempohkhidmat; ?>" required>
