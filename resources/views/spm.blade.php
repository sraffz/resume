    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><strong>SPM</strong></div>
                ...
                <div class="panel-body">
                    ...
                    <div class="panel-body">
                    <form class="col-lg-12 col-md-offset-2 form-horizontal" method="POST" action="{{ url('/spm')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                             <select class="form-control" name="mt2">
                                  <option value="BAHASA INGGERIS" selected>BAHASA INGGERIS</option>
                                    {{-- @include('matapelajaran.mtspm'); --}}
                                  </select>
                              </div>
                                <div class="col-md-3">
                            ...
                            <div class="col-md-4">
                             <select class="form-control" name="mt4">
                              <option value="SEJARAH" selected>SEJARAH</option>
                                ...
                                <div class="col-md-3">
                                <select class="form-control" name="grad4" required>
                                    @include('gred.gredspm');
                                  </select>
                                  </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                             <select class="form-control" name="mt5" required>
                                    @include('matapelajaran.mtspm');
                                  </select>
                              </div>
                                <div class="col-md-3">
                                <select class="form-control" name="grad5" required>
                                    @include('gred.gredspm');
                                  </select>
                                  </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                             <select class="form-control" name="mt6" required>
                                    @include('matapelajaran.mtspm');
                                  </select>
                              </div>
                                <div class="col-md-3">
                                <select class="form-control" name="grad6" required>
                                    @include('gred.gredspm');
                                  </select>
                                  </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                             <select class="form-control" name="mt7" required>
                                    @include('matapelajaran.mtspm');
                                  </select>
                              </div>
                                <div class="col-md-3">
                                <select class="form-control" name="grad7" required>
                                    @include('gred.gredspm');
                                  </select>
                                  </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-4">
                             <select class="form-control" name="mt8" required>
                                    @include('matapelajaran.mtspm');
                                  </select>
                              </div>
                                <div class="col-md-3">
                                <select class="form-control" name="grad8" required>
                                    @include('gred.gredspm');
                                  </select>
                                  </div>
                        </div>
