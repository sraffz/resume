            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" method="POST" action="{{ url('/sijil2')}}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group{{ $errors->has('tempatbelajar') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="tempatbelajar" type="tempatbelajar" class="form-control" name="tempatbelajar" value="{{ old('tempatbelajar') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('kursus') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="kursus" type="kursus" class="form-control" name="kursus" value="{{ old('kursus') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('cgpa') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-12">
                                            <input onkeyup="this.value = this.value.toUpperCase();" id="cgpa" type="cgpa" class="form-control" name="cgpa" value="{{ old('cgpa') }}" required>
