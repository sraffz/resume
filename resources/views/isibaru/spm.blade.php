                                ...
                                <form class="col-lg-12 col-md-offset-2 form-horizontal" method="POST" action="{{ url('/spm')}}">
                                  {{ csrf_field() }}
                                      ...
                                      <table class="table no-border mini-table m-t-20">
                                          ...
                                          <tr>
                                            <td>
                                              <input type="text" name="mt11" class="form-control" placeholder="Matapelajaran" value="">
                                            </td>
                                            <td>
                                          ...
                                          <tr>
                                            <td>
                                              <input type="text" name="mt12" class="form-control" placeholder="Matapelajaran" value="">
                                            </td>
                                            <td>
                                          ...
                                          <tr>
                                            <td>
                                              <input type="text" name="mt13" class="form-control" placeholder="Matapelajaran" value="">
                                            </td>
                                            <td>
                                          ...
                                          <tr>
                                            <td>
                                              <input type="text" name="mt14" class="form-control" placeholder="Matapelajaran" value="">
                                            </td>
                                            <td>
                                          ...
                                          <tr>
                                            <td>
                                              <input type="text" name="mt15" class="form-control" placeholder="Matapelajaran" value="">
                                            </td>
                                            <td>
