      ...
      <div class="panel panel-primary">
        <div class="panel-body">
          ...
          <div class="col-md-6">
            ...
            <form class="form-inline" method="GET" action="{{ url('/carian-resume-guru') }}">
              @csrf
            ...
            <table id="zero_config" class="table table-bordered ">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <center>
                      <a target="_blank" href='{{ url("/admin/butiran-pemohon/{$pemohons->id}") }}'
                        class="btn btn-success btn-xs">Butiran</a>
                      {{-- <a target="_blank" href='{{ url("/admin/butiran-pemohon/{$pemohons->id}") }}' class="btn
                      btn-danger btn-xs">Padam</a> --}}

                      <!-- Button trigger modal -->
                      <button type="button" class="btn btn-danger btn-xs" data-toggle="modal"
                        data-target="#padampermohonan">
                        Padam
                      </button>
                    </center>
                    <!-- Modal -->
                    <div class="modal fade" id="padampermohonan" tabindex="-1" role="dialog"
...
<div class="modal fade" id="exportdetailguru" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ url('/muat-turun-butiran-pemohon') }}" method="get">
        <div class="modal-body">
