      ...
      <div class="panel panel-primary">
        <div class="panel-body">
          <div class="col-md-6 text-right">
            ...
            <div style="float: left "><a href="{{ url('/admin/pelaporan-permohonanGuru') }}"> Kembali</a></div>
            <div style="float: right">
              <a class="btn btn-primary" href="{{ url('/muat-turun-butiran-laporanguru', [$jawatan, $maklumatdiri]) }}" > Muat Turun Butiran</a>
              {{-- <a class="btn btn-primary" href="{{ url('/muat-turun-butiran-laporanguru?jawatan='.$jawatan.'maklumatdiri='.$maklumatdiri.'gred='.$gred.'bidang='.$bidang. '') }}" > Muat Turun Butiran</a> --}}
           </div>
          </div>
        </div>
      </div>
