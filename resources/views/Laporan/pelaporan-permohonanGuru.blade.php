        ...
        <div class="panel panel-primary">
          <div class="panel-body">
            ...
            <label text-align="center">
              <legend><b>PELAPORAN PERMOHONAN KERJA DI YIK</b></legend>
            </label>

            <form class="form-inline" method="GET" action="{{ url('/carian-laporan-kerja-guru') }}">
              <div class="row">
                <div class="col-25">
              ...
              <br><br>
              <div class=center>
                <button type="submit" href="{{ url('/pelaporan-listData') }}" class="btn btn-primary">Hantar</button>
              </div>
              <br>
            </form>
          </div>
